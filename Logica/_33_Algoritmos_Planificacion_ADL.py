...
estado_objetivo = {"en_trabajo": True, "tiene_llave": True}
acciones = [
    Accion("ir_al_trabajo", {"en_casa": True, "tiene_llave": True}, {"en_casa": False, "en_trabajo": True}),
    Accion("buscar_llave", {"en_casa": True, "tiene_llave": False}, {"tiene_llave": True})
]
